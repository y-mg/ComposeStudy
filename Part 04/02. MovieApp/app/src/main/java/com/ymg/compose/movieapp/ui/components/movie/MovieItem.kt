...
import com.ymg.compose.movieapp.features.common.entity.MovieFeedItemEntity
...
@Composable
fun Poster(
    thumbnailMovie: com.ymg.compose.movieapp.features.common.entity.MovieFeedItemEntity,
    input: IFeedViewModelInput
) {
    Card(
        onClick = {
